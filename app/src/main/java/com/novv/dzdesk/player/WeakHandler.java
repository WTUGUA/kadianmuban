 ...
 * could collect them once WeakHandler instance is not referenced any more
 * <p/>
 *
 * @see Handler
 * <p>
...
public class WeakHandler {
     ...
     * <p>
     * If this thread does not have a looper, this handler won't be able to receive messages so an
     * exception is thrown.
     */
    public WeakHandler() {
        mCallback = null;
    ...
    /**
     * Constructor associates this handler with the {@link Looper} for the current thread and takes
     * a callback interface in which you can handle messages.
     * <p>
     * If this thread does not have a looper, this handler won't be able to receive messages so an
     * exception is thrown.
     *
    ...
    /**
     * Causes the Runnable r to be added to the message queue, to be run at a specific time given
     * by
    ...
    /**
     * Posts a message to an object that implements Runnable. Causes the Runnable r to executed on
     * the next iteration through the message queue. The runnable will be run on the thread to which
     * this handler is attached.
     * <b>This method is only for use in very special circumstances -- it
     * can easily starve the message queue, cause ordering problems, or have other unexpected
     * side-effects.</b>
     *
     * @param r The Runnable that will be executed.
     ...
     * (in milliseconds) <var>uptimeMillis</var>.
     * <b>The time-base is {@link android.os.SystemClock#uptimeMillis}.</b>
