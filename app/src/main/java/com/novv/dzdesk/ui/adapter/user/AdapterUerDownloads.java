...
public class AdapterUerDownloads extends BaseQuickAdapter<ResourceBean, BaseViewHolder> {
    ...
    @Override
    protected void convert(final BaseViewHolder helper, ResourceBean item) {
