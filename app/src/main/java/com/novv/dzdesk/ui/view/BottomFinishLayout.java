 ...
 *
 */
public class BottomFinishLayout extends RelativeLayout {
    ...
    public BottomFinishLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BottomFinishLayout(Context context, AttributeSet attrs, int defStyle) {
