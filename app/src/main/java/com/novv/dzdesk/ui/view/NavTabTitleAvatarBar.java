...
public class NavTabTitleAvatarBar extends LinearLayout
        implements
        View.OnClickListener {

    private static final String tag = NavTabTitleAvatarBar.class.getSimpleName();
    ...
    public NavTabTitleAvatarBar(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public NavTabTitleAvatarBar(Context context, AttributeSet attrs, int defStyle) {
