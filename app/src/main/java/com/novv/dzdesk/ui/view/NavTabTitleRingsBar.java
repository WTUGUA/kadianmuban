...
public class NavTabTitleRingsBar extends LinearLayout
        implements
        View.OnClickListener {

    private static final String tag = NavTabTitleRingsBar.class.getSimpleName();
    ...
    public NavTabTitleRingsBar(Context context) {
        super(context);
    }

    public NavTabTitleRingsBar(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public NavTabTitleRingsBar(Context context, AttributeSet attrs, int defStyle) {
