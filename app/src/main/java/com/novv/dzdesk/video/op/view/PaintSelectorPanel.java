...
public class PaintSelectorPanel extends LinearLayout {
    ...
    private class PaintColorListAdapter extends
            RecyclerView.Adapter<PaintSelectorPanel.ItemViewHolder> {
        ...
        @Override
        public PaintSelectorPanel.ItemViewHolder onCreateViewHolder(ViewGroup parent,
                int viewType) {
            Context context = parent.getContext();
            LayoutInflater inflater = LayoutInflater.from(context);
            View contactView = inflater.inflate(R.layout.item_paint_color, parent, false);
            PaintSelectorPanel.ItemViewHolder viewHolder = new PaintSelectorPanel.ItemViewHolder(
                    contactView);
            return viewHolder;
        }
        ...
        public void onBindViewHolder(final PaintSelectorPanel.ItemViewHolder holder, int position) {
            ...
            holder.mImageView.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (mOnPaintSelectorListener != null) {
                        mOnPaintSelectorListener
                                .onPaintColorSelected(mContext.getResources().getColor(color));
                    }
                }
            });
